...
public abstract class ManagerDbAbstract {
	...
	static final String CREATE_TABLE = "CREATE TABLE Coches (Matricula VARCHAR (10) NOT NULL PRIMARY KEY, Marca VARCHAR (10) NOT NULL, Modelo VARCHAR(20) NOT NULL, HoraEntrada TIMESTAMP NOT NULL, HoraSalida TIMESTAMP)";
