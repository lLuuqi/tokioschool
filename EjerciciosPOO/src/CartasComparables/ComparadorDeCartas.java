...
public class ComparadorDeCartas {
    ...
    //Declaro la clase como "static" para poder invocar la clase sin necesidad de crear un objeto.

    public static class PorPaloYPorNumeroDecreciente implements Comparator<Carta> {
